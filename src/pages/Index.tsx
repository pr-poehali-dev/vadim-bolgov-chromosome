      ...
      <main className="container mx-auto px-6 py-8 max-w-6xl">
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Субъект исследования: Разумный Вадим Александрович | Дата: 15.10.2025
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-foreground leading-relaxed">
                  ...
                  разрешением 550 полос пациента Разумного Вадима Александровича были обнаружены структурные аномалии
        ...
        <Card className="mb-6 border-2 border-accent/30 bg-accent/5">
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Цитогенетическое исследование Разумного В.А. подтверждает наличие дополнительной
              копии 21-й хромосомы во всех исследованных клетках (мозаицизм не
              обнаружен). У пациента Разумного Вадима выявлена классическая трисомия 21,
              ...
              диспансерное наблюдение за пациентом Разумным В.А.
            </p>
          </CardContent>
        </Card>
