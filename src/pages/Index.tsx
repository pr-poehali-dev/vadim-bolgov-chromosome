      ...
      <main className="container mx-auto px-6 py-8 max-w-6xl">
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Субъект исследования: Болгов В.А. | Дата: 15.10.2025
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-foreground leading-relaxed">
                  ...
                  разрешением 550 полос были обнаружены структурные аномалии
                  хромосомного набора. Цитогенетический анализ показал наличие
                  дополнительной хромосомы в клетках периферической крови.
                </p>
              </div>
        ...
        <Card className="mb-6 border-2 border-accent/30 bg-accent/5">
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Цитогенетическое исследование подтверждает наличие дополнительной
              копии 21-й хромосомы во всех исследованных клетках (мозаицизм не
              обнаружен). Данная аномалия ассоциирована с характерным
              фенотипическим проявлением и когнитивными особенностями.
